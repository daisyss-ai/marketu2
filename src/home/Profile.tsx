      ...
      <div className="max-w-5xl mx-auto px-4 pb-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#4B187C] text-white text-sm font-medium hover:bg-[#3E1367] transition-colors"
          >
        ...
        {profileLoading || productsLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div
              onClick={() => router.push('/sell')}
              className="border-2 border-dashed border-[#EDE7FF] rounded-2xl flex flex-col items-center justify-center p-6 bg-white hover:bg-purple-50 cursor-pointer transition-colors min-h-[200px]"
            >
